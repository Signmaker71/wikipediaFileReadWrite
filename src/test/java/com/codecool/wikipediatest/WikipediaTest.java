...
// Testing Sign In
    ...
    public void logInDesktop() {
        ...
        userName.clear();
        userName.sendKeys("Szuperteszter01");

        WebElement psw = webDriver.findElement(By.id("wpPassword1"));
        psw.clear();
        psw.sendKeys("xgjrdhv123");
        ...
        Assertions.assertEquals("Felhasznalo01", loggedUser.getText());
    }
    ...
    public void logInDesktopWithFileInput() {
        ...
        WebElement loggedUser = webDriver.findElement(By.xpath("//*[@id='pt-userpage']/a"));
        Assertions.assertEquals(credential[0], loggedUser.getText());
    }
